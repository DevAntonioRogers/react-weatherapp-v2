...
export default function Home() {
  ...
  return (
    <div className="flex justify-center  bg-cover bg-gradient-to-r from-blue-500 to-blue-300">
      <div className="bg-white/25 mx-24 w-[300px] rounded-lg flex flex-col h-fit">
